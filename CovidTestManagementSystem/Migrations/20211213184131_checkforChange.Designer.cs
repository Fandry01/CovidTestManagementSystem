...
namespace CovidTestManagementSystem.Migrations
{
    ...
    [Migration("20211213184131_checkforChange")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CovidTestManagementSystem.Models.TestRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CovidTestManagementSystem.Models.TestTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CovidTestManagementSystem.Models.Person", b =>
                {
            ...
            modelBuilder.Entity("CovidTestManagementSystem.Models.TestRecord", b =>
                {
                    b.HasOne("CovidTestManagementSystem.Models.Person", "Name")
                        .WithMany("TestRecords")
                        .HasForeignKey("PatientId");

                    b.HasOne("CovidTestManagementSystem.Models.TestAppointment", "Appointment")
                        .WithMany()
            ...
            modelBuilder.Entity("CovidTestManagementSystem.Models.TestRecordVM", b =>
                {
                    b.HasOne("CovidTestManagementSystem.Models.TestAppointment", "TestAppointment")
                        .WithMany()
                        .HasForeignKey("TestAppointmentId");
                });
